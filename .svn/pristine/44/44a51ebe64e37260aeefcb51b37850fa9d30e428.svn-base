...
router.post('/getStartInfo', function (req, res) {
    ...
    http.post('127.0.0.1:8080/hotMovie/find', req.body).then(function (data) {
        res.send(data);
    })
});
...
//增加数据
router.post('/hot_movie_addNum', function (req, res) {
    http.post('127.0.0.1:8080/hotMovie/add',req.body).then(function (data) {
        res.send(data);
    })
});
...
router.post('/delInfo', function (req, res) {
    ...
    console.log(param)
    http.post("127.0.0.1:8080/hotMovie/del",param).then(function (data) {
        res.send(data);
    });
});
